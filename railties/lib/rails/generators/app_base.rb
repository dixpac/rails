  ...
  module Generators
    class AppBase < Base # :nodoc:
      ...
      def self.add_shared_options_for(name)
        ...
        class_option :skip_pagination, type: :boolean, default: nil,
          desc: "Skip geared_pagination gem"
      ...
      private
        ...
        def build(meth, *) # :doc:
          builder.public_send(meth, *) if builder.respond_to?(meth)
        end
        ...
        def skip_pagination?
          options[:skip_pagination] || options[:skip_active_record]
        end
