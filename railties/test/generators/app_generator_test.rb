...
class AppGeneratorTest < Rails::Generators::TestCase
  ...
  def test_geared_pagination_gem_is_included_by_default
    run_generator

    assert_gem "geared_pagination"
  end

  def test_skip_pagination_option
    generator([destination_root], skip_pagination: true)
    run_generator_instance

    assert_no_gem "geared_pagination"
  end

  def test_skip_pagination_when_skip_active_record
    generator([destination_root], skip_active_record: true)
    run_generator_instance
  ...
  def test_inclusion_of_ruby_version
    ...
    assert_file ".ruby-version" do |content|
      if ENV["RBENV_VERSION"]
        ...
        assert_match(/#{RUBY_ENGINE}-#{RUBY_ENGINE_VERSION}/o, content)
      end
  ...
  def test_devcontainer
    ...
    assert_file(".devcontainer/Dockerfile") do |content|
      assert_match(/ARG RUBY_VERSION=#{RUBY_VERSION}/o, content)
